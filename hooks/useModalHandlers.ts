...
function useModalHandlers<T>(defaultModalValue: T): IUseModalHandlersOutputWithDefaultValue<T>;
function useModalHandlers<T>(defaultModalValue?: T): IUseModalHandlersOutput<T> {
